      ...
      <Header />
       ...
       <br />
          <div className="header-body">
            ...
            <Row>
              <Col lg="12" xl="3">
              <h3 className="mt-6">Expense Report</h3>
              ...
              <CardHeader className="bg-transparent">
                <Row className="align-items-center">
                  <div className="col">
                    ...
                    <h2 className="text-white mb-0">$45,000</h2>
                  </div>
                  <div className="col">
                    <Nav className="justify-content-end" pills>
                      <NavItem>
                        ...
                        >
                          <span className="d-none d-md-block">Export Details</span>
          ...
          <Col xl="4">
            <Card className="shadow">
              ...
              <CardBody>
                ...
                {/* <div class="progress"> */}
                <div className="progress-bar bg-primary" role="progressbar"  aria-valuenow="25" style={{width: "50%"}} aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p>Completed</p>

                <div className="progress">
                  <div className="progress-bar bg-primary" role="progressbar"  aria-valuenow="50" style={{width: "30%"}} aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p>Pending</p>
